...
public class DispatcherServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            //拿到spring的容器，因为Service交给spring管理，所以Service实现ApplicationContextAware接口的
            //setApplicationContext(ApplicationContext applicationContext)方法后，这个方法会被spring自动调用
            //从而，Service类的成员变量 applicationContext 被赋值
